...
HD_PWD='D:/sakthivel/fpga_practice/sample/sample.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StochasticFIR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StochasticFIR.tcl
